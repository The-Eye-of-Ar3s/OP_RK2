...
if (Test-Path -Path C:\Games\ETM\user\mods\oprk2\) {
    Remove-Item -Recurse -Force C:\Games\ETM\user\mods\oprk2\ | out-null
}
mkdir C:\Games\ETM\user\mods\oprk2\ | out-null
Copy-Item -Recurse -Path .\dist\* -Destination C:\Games\ETM\user\mods\oprk2\ | out-null
